...
const file_proto_greeter_proto_rawDesc = "" +
	"\n" +
	"\x13proto/greeter.proto\x12\x16grpcTestingWithBufconn\"\"\n" +
	...
	"\aGreeter\x12V\n" +
	"\bSayHello\x12$.grpcTestingWithBufconn.HelloRequest\x1a\".grpcTestingWithBufconn.HelloReply\"\x00B2Z0github.com/miparnisari/grpc-testing-with-bufconnb\x06proto3"
...
var file_proto_greeter_proto_goTypes = []any{
	(*HelloRequest)(nil), // 0: grpcTestingWithBufconn.HelloRequest
	(*HelloReply)(nil),   // 1: grpcTestingWithBufconn.HelloReply
}
var file_proto_greeter_proto_depIdxs = []int32{
	0, // 0: grpcTestingWithBufconn.Greeter.SayHello:input_type -> grpcTestingWithBufconn.HelloRequest
	1, // 1: grpcTestingWithBufconn.Greeter.SayHello:output_type -> grpcTestingWithBufconn.HelloReply
