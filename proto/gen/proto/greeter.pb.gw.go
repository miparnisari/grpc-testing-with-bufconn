...
/*
Package grpc_testing_with_bufconn is a reverse proxy.

It translates gRPC into RESTful JSON APIs.
*/
package grpc_testing_with_bufconn
...
func RegisterGreeterHandlerServer(ctx context.Context, mux *runtime.ServeMux, server GreeterServer) error {
	mux.Handle(http.MethodPost, pattern_Greeter_SayHello_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		annotatedContext, err := runtime.AnnotateIncomingContext(ctx, mux, req, "/grpcTestingWithBufconn.Greeter/SayHello", runtime.WithHTTPPathPattern("/grpcTestingWithBufconn.Greeter/SayHello"))
		if err != nil {
...
func RegisterGreeterHandlerClient(ctx context.Context, mux *runtime.ServeMux, client GreeterClient) error {
	mux.Handle(http.MethodPost, pattern_Greeter_SayHello_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		defer cancel()
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		annotatedContext, err := runtime.AnnotateContext(ctx, mux, req, "/grpcTestingWithBufconn.Greeter/SayHello", runtime.WithHTTPPathPattern("/grpcTestingWithBufconn.Greeter/SayHello"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
...
var (
	pattern_Greeter_SayHello_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1}, []string{"grpcTestingWithBufconn.Greeter", "SayHello"}, ""))
)
